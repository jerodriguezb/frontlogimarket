...
export const getLocalidades = async () => {
  let url = `http://localhost:3004/localidades`;
  const options = {
    method: "GET",
    headers: {
...
export const getLocalidadId = async (id) => {
  let url = `http://localhost:3004/localidades/${id}`;
  const options = {
    method: "GET",
    headers: {
      "content-type": "application/x-www-form-urlencoded",
...
// };
// Crear nuevo empresa
export const addLocalidad = async (datos) => {
  // console.log(datos);
